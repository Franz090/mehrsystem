    ...
    <div class="container-fluid default">
      <div class="background-head row m-2 my-4">
        ...
        <form class="form form-box px-3" action="" method="post">
            ...
            <div class=" mb-3">
                <input type="text" class="form-control"  name="first_name" autofocus placeholder="First Name*" 
        ...
        <div class="col-sm-4">
            ...
            <button class="w-40 btn-primary btn text-capitalize mb-5" type="submit" name="submit">Update Infant</button> 
                </div>
