    ...
    <div class="bg-dark" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush my-3" style="color:whitesmoke;">
        <a href="../admindashboard.php"
          class="h6 text-light list-group-item list-group-item-action bg-transparent second-text active"><i
        ...
        <div class="dropdown-container">
          <div class="merge">
            <i class="fas fa-light fa-minus"></i><a type="button" class="drop bg-transparent second-text active ">Change
              Password</a>
